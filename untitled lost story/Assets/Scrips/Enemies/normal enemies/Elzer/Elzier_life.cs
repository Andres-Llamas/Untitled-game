...
public class Elzier_life : MonoBehaviour
{
    public float life = 3;
    ...
    void Start()
    {
        ...
        checkGround = GameObject.FindGameObjectWithTag("Player").GetComponentInChildren<Check_grounded>();
        playerController = GameObject.FindGameObjectWithTag("Player").GetComponent<Player_controller>();
        swordDownPlayer = GameObject.FindGameObjectWithTag("Player").GetComponentInChildren<Sword_collision>();
    }
